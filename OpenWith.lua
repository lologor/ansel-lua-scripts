...
local function OpenWith(images, choice, copy) 
  ...
  if dt.configuration.running_os == "macos" then bin = "open -a "..bin end
...
for i = 1, MAX_EDITORS do
  dt.register_event(MODULE_NAME, "shortcut", program_shortcut, _("edit with program ")..string.format("%02d", i)) 
  end
